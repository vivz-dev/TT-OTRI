// ============================================================================
// File: Infrastructure/InMemory/TechnologyRepository.cs
...
{
    private readonly List<Technology> _store = new()
    {
        new()
        {
    ...
    public Task<IEnumerable<Technology>> GetAllAsync(CancellationToken ct = default)
        => Task.FromResult(_store.AsEnumerable());

    public Task<Technology?> GetByIdAsync(int id, CancellationToken ct = default)
        => Task.FromResult(_store.FirstOrDefault(x => x.Id == id));

    public Task AddAsync(Technology e, CancellationToken ct = default)
    {
    ...
    public Task UpdateAsync(Technology e, CancellationToken ct = default)
    {
